...
from .vehicle import tonnage_volume_mapping_bp
from .vehicle.vehicle_capacity_reference_routes import vehicle_capacity_reference_bp
...
api_v1_bp.register_blueprint(tonnage_volume_mapping_bp, url_prefix='/vehicle/tonnage-volume')
api_v1_bp.register_blueprint(vehicle_capacity_reference_bp)
