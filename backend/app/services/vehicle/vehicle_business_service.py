...
class VehicleBusinessService:
    ...
    def vehicle_to_dict(vehicle):
        ...
        return {
            ...
            'plate_number': vehicle.license_plate, # 兼容旧字段
            ...
            'volume_photo_url': vehicle.volume_photo_url,
            'volume_modified_by': vehicle.volume_modified_by,
            'required_volume': vehicle.required_volume,
            'confirmed_volume': vehicle.confirmed_volume,
            'supplier_id': vehicle.supplier_id,
            'supplier_type': vehicle.supplier_type,
            'confirmed_by': vehicle.confirmed_by,
            'confirmed_at': vehicle.confirmed_at,
            'is_merged': vehicle.is_merged,
            'is_downgraded': vehicle.is_downgraded,
            'original_capacity': vehicle.original_capacity,
            'task_id': vehicle.task_id,
            'manifest_number': vehicle.manifest_number,
            'dispatch_number': vehicle.dispatch_number
        }